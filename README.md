...
| "**상위지침**(정원·보수·예산) 범주 내인가" | 알리오 게시판 수동 검색 | **경영지침 결합** — 공운법 제50조 지침 78건 조문 대조 (법제처 미등재) |
...
| E 경영지침 | `list_mgmt_guidelines` | 재정경제부 경영지침(공운법 제50조) 현행/연혁 목록·검색 — **법제처 미등재**, 알리오 공시 78건 |
...
- 내부규정 코퍼스·타 기관 규정·경영지침: **알리오 공개 공시 데이터** (비공개 사규 미포함)
- 경영지침: 재정경제부가 공운법 제50조에 따라 정해 통보하는 지침(**법제처 미등재**) — 알리오 '공공기관 법령/지침' 게시판 78건, 현행/연혁 자동 분류
